...
ajouter.addEventListener('click', function() {
    ...
    modifier.setAttribute('class', 'btn btn-secondary');
    ...
    if (!validerCree) {
        ...
        valider.setAttribute('class', 'btn btn-secondary');
...
function modifierLigne(ligne) {
    ...
    boutonSauvegarde.setAttribute('class', 'btn btn-secondary');
...
function sauvegarderModification(ligne) {
    ...
    boutonModifier.setAttribute('class', 'btn btn-secondary');
